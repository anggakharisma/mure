...
const Footer = () => {
  return (
    <div className="w-5/6 mx-auto flex gap-12 items-center align-middle">
      <h1 className="my-auto text-3xl font-[900] tracking-tighter text-primary">
        MURE
      </h1>
      <div className="relative w-5/6 mx-auto h-full p-12 rounded-lg  my-12 bg-primary before:w-full before:h-full before:-top-4 before:-right-4 before:bg-accent before:absolute before:-z-10 before:rounded-lg after:w-full after:h-full after:-top-8 after:-right-8 after:bg-secondary after:absolute after:-z-20 after:rounded-lg">
