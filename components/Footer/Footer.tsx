const Footer = () => {
  return (
    <div className="w-5/6 mx-auto flex">
      ...
      <div className="relative w-1/3 ml-8 h-full p-8 rounded-lg  my-12 bg-primary before:w-full before:h-full before:-top-4 before:-right-4 before:bg-accent before:absolute before:-z-10 before:rounded-lg after:w-full after:h-full after:-top-8 after:-right-8 after:bg-secondary after:absolute after:-z-20 after:rounded-lg">
