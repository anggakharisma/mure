    ...
    <div className={HeroStyles.hero}>
      ...
      <div className="z-30 mx-auto lg:block lg:relative">
        <h1
          ...
          className="z-30 mx-auto font-black leading-snug text-center lg:w-2/4 lg:text-[96px] lg:ml-0 text-accent text-7xl title-shadow lg:text-left tracking-wider"
        >
          SHARE
          <br /> LISTEN
          <br /> DISCOVER
